export const LANDING_TEXTS = {
  HERO: {
    SUBTITLE: 'Con nuestro servicio a domicilio disfruta de',
    TITLE_PRIMARY: 'PAPUT',
    TITLE_SECONDARY: 'EN CASA',
    HERO_ALT: 'Paput Hero',
  },
  SECTION_1: {
  ...
  SECTION_2: {
    OUR_BURGERS_ALT: 'Nuestras Burgers',
    BURGERS: [
      {
        title: 'LA CLÁSICA',
  ...
  SECTION_3: {
    MOTTO: 'NOS VESTIMOS COMO HABLAMOS, A POC A POC Y CON SABOR A MENORCA.',
    STORE_BUTTON_LABEL: 'NUESTRA TIENDA',
  ...
  SECTION_4: {
    LOCATIONS: [
      ...
      },
      {
        ...
        hours: 'Todos los días de 19:30H a 23:00H',
      },
    ],
    FOOTER_TEXT:
  ...
  SOCIAL: {
    WHATSAPP: 'https://wa.me/34666666666',
